					...
					<MDBCol lg="6" md="12">
						<div style={{
							...
							<MDBView hover rounded className="z-depth-1-half mb-4">
								<img
									className="img-fluid"
									src="https://cdn.pixabay.com/photo/2017/11/27/11/59/scenery-2981200_960_720.jpg"
									alt=""
					...
					<MDBCol lg="6" md="12">
						<div style={{
							...
							<MDBView hover rounded className="z-depth-1-half mb-4">
								<img
									className="img-fluid"
									src="https://cloud.addictivetips.com/wp-content/uploads/2017/02/mail-app-settings-personalization.jpg"
									alt=""
									style={{ height: '400px', width: '100%' }}
								/>
								<a href="#!">
